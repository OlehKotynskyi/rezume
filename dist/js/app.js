(() => {
    ...
    let script_elements = document.querySelectorAll(".number");
    script_elements.forEach((function(item, i, arr) {
        item.innerHTML = i + 1 + ".";
    }));
    const big = document.querySelector(".aside__wrap-img");
    big.addEventListener("click", (function(e) {
        if (big) big.classList.toggle("_big");
    }));
    window["FLS"] = true;
    isWebp();
})();